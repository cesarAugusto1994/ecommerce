                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li><a href="{{ route('produtos_editar', ['id' => $produto->id])  }}">Editar</a></li>
                                <li><a href="{{ route('imagens_adicionar', ['id' => $produto->id]) }}">Imagens</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="{{ route('produto_status', ['id' => $produto->id]) }}">{{ $produto->ativo ? 'Inativar' : 'Ativar' }}</a></li>
                            </ul>
                        </div>
                    </td>
                    <td>{{ $produto->nome  }}</td>
